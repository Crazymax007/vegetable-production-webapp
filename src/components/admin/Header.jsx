...
const Header = ({ toggleSidebar, handleLogout }) => {
  ...
  return (
    <header className="bg-white px-6 py-3 shadow-sm flex justify-between items-center border-b border-gray-200">
      <button
      ...
      <div className="relative">
        ...
        >
          ...
          <span className="block mr-1 font-semibold">Admin</span>
          <svg
